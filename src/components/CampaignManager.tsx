  ...
  return (
    <div className="space-y-8">
      <form
        ...
        className="flex flex-col gap-3 rounded-2xl border border-gray-800 bg-gray-950 p-5 sm:flex-row sm:items-end"
      >
        ...
        {campaigns.map((campaign) => (
          ...
          >
            ...
            <select
              ...
              className="rounded-lg border border-gray-700 bg-gray-900 px-2 py-1 text-sm text-white"
            >
            ...
            <button
              ...
              className="self-start text-sm font-medium text-red-400 hover:underline"
            >
              Eliminar
            </button>
          </div>
